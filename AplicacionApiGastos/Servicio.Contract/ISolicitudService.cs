...
namespace Service.Contracts
{
    public interface ISolicitudService 
    {
        ...
        Task<Modelo.General.Correo> GetSolicitudCorreo(int id);
        ...
        Task<List<Modelo.Request.Beneficiado>> GetListBeneficiadoBySolicitud(int? id);
        ...
        Task<List<Modelo.Request.Destino>> GetListDestinoByProveedor(int idSolicitud, int idProveedor);
        ...
        Task<SolicitudRechazo> Recuperar(SolicitudRechazo entSolicitud);
        Task Actualizar(SolicitudRechazo entSolicitud);
        Task<int> Grabar(SolicitudDetalle entSolicitudDetalle);
    }
}
