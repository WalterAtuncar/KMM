...
{
    public interface IProveedorServiceLogic
    {
        Task<OperationResult> Add(Data.Common.ProveedorTaxi proveedor);
        Task<bool> ValidarProveedor(string ruc, int id);
        Task<OperationResult> Modificar(Data.Common.ProveedorTaxi proveedor);
